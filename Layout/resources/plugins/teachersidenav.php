...
<?php
        ...
        <a href="teacherclearance.php"> <i class="<?php if ($path=="/LAYOUT/teacherclearance.php" || $path=="/LAYOUT/clearance-edit.php") {echo "active"; }?> fas fa-pen-square teacher-icons" aria-hidden="true" style="font-size:50px"></i><br>Clearance Form</a>
