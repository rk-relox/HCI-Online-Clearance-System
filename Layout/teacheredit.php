...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    contact_number = '$contact_number', birthday = '$birthday', address = '$address', 
...
<?php include "resources/plugins/teachersidenav.php" ?>
    ...
    <div class="container2">
        ...
        <label>First name: </label>
            ...
            <br>
            <input type="text" name="ContactNumber" value="<?php echo $row['contact_number']?>" placeholder="Contact Number">
            <br><br>
