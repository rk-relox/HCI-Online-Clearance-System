...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = mysqli_query($conn, "SELECT * FROM teacher WHERE email = '$email' OR username = '$username'");
    ...
    (first_name, middle_name, last_name, email, birthday, address, username, password) 
    VALUES ('$first_name', '$middle_name', '$last_name', '$email', '$birthday', '$address', '$username', '$password')";
